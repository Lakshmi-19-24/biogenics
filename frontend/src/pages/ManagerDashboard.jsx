...
export default function ManagerDashboard() {
  ...
  useEffect(()=>{ (async()=>{ try{ const data=await dispatch(fetchDashboard()).unwrap(); setStats({teamSize:data.stats.teamSize,leadsAssigned:data.stats.leads,ordersClosed:data.stats.orders,teamRevenue:data.stats.revenue}); }catch{} finally{setLoading(false);} })(); },[dispatch]);

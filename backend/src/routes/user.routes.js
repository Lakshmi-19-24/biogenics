...
import { createUser, deleteUser, getUser, listUsers, updateUser, uploadAvatar, getProfile, updateProfile, changePassword, listProfileChangeRequests, decideProfileChangeRequest } from '../controllers/user.controller.js';
...
userRouter.delete('/:id', authorize(...MANAGEMENT_ROLES), deleteUser);

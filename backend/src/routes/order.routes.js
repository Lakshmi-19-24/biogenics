...
import { createOrder, deleteOrder, getOrder, listOrders, updateOrderStatus, fulfillBackorder } from '../controllers/order.controller.js';
...
orderRouter.delete('/:id', authorize(...ADMIN_ROLES, ROLES.MANAGER), deleteOrder);
